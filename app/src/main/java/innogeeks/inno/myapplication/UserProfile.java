...
/**
 * Created by Trinadh on 29-07-2017.
 */
...
private String myJSON;JSONArray testbuttonscat = null,testbuttonsub=null;
    ...
    OnClickListener btnclick,btnclick1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        brsl.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                //Intent intent1 = new Intent(UserProfile.this, Resulhome.class);
                Intent intent1 = new Intent(UserProfile.this, Quizrslh.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent1 = new Intent(UserProfile.this, Quiz.class);
startActivity(intent1);
        ...
        testsub.setOnItemSelectedListener(//this);
                new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> adapterView, View view,
                        ...
                        if (item != null) {
                            //Toast.makeText(UserProfile.this, item.toString(),
                                    //Toast.LENGTH_SHORT).show();
                        }
                        //Toast.makeText(UserProfile.this, "Selected sub cat " + position,
                                //Toast.LENGTH_SHORT).show();
...
//int a =
                        ...
                        //Toast.makeText(UserProfile.this, "Selected sub cat  value" + ctgid,
                                //Toast.LENGTH_SHORT).show();
        ...
        testcat.setOnItemSelectedListener(//this);
                new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> adapterView, View view,
                        ...
                        //Toast.makeText(UserProfile.this, "Selected" + position,
                                //Toast.LENGTH_SHORT).show();
                        showListsub(position+1);
  ...
  //                  //Toast.makeText(getApplicationContext(),"s value " +s+catname, //Toast.LENGTH_LONG).show();
    ...
    protected void addquizbtn(int quiz){
        ...
        try {
            ...
            LinearLayout ll1 = (LinearLayout) findViewById(R.id.dynbut);
            ll1.removeAllViews();
            //Toast.makeText(UserProfile.this, "catquiz length " +catquiz.length(), //Toast.LENGTH_SHORT).show();
            int chk=0 ,ver=0,a=0;
            int compscr=0;
            for(int i=0;i<catquiz.length();i++){
                ...
                String cid = c.getString("c_id");
                //Toast.makeText(UserProfile.this, "quiz value " +quiz, //Toast.LENGTH_SHORT).show();
